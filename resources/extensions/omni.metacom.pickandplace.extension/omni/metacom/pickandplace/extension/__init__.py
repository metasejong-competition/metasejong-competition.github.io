...
class OmniMetacomPickandplaceExtensionExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.metacom.pickandplace.extension] OmniMetacomPickandplaceExtensionExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.metacom.pickandplace.extension] OmniMetacomPickandplaceExtensionExtension shutdown", flush=True)
